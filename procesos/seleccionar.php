	...
	if($consulta2->rowCount()>=1){
		...
		?>
					...
					<tr>
						...
						<td colspan=1><input  id='txtm_asig'  name='txtm_asig'  value ="<?php echo number_format($previsto,2,'.','');?>" readonly='readonly'></td>
						<td colspan=1><input  id='txtm_eje'  name='txtm_eje'  value ="<?php echo number_format($real,2,'.','');?>" required=''></td>
						<td colspan=1><input style="<?php echo $style;?>" id='txt_dif'  name='txt_dif'  value ="<?php echo number_format($diferencia,2,'.','');?>" readonly='readonly'></td>
				<!--		<td colspan=2>
...
<!--<tr>
	...
	<tr>
		...
		<td colspan='' style="color: rgb(244, 101, 36);" >
