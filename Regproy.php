...
<tr>
  ...
  <td colspan="4">Descripción</td>
    ...
    <td colspan="2">Monto Ejecutado</td>
  </tr>

  <tr>
    <td colspan="1"><input type="txt" id="txtitem" name="item"></td>
  <td colspan="4"><input type="txt" id="txt_des" name="descripcion"></td>
  <td colspan="2"><input type="txt" id="txtm_asi" name="m_asi"></td>
  <td colspan="2"><input type="txt" id="txtm_eje" name="m_eje"></td>
  </tr>
